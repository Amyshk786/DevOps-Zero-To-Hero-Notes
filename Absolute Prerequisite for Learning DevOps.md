...
- Business Analyst - Gather and Documents Customer Requirements [Creates Business Requirements Document (BRD) Document].
...
- Product Owner - Manages Backlog and Converts Vision/Requirements into Actionable Stories / Actionable Items (Epics).
...
- Software Architect - Designs Technical Systems Structure and Frameworks [Prepares HLD & LLD].
